...
% Set \downstreamdir to this directory relative to your main .tex before \input-ing
...
\providecommand{\downstreamdir}{.}
\input{\downstreamdir/generated/downstream_tables}
