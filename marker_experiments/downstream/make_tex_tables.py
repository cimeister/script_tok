...
def main(
    ...
    Args:
        ...
        trainer: Which trainer's cells to report. The manifest holds one entry per
            (corpus, arm, trainer), and mixing trainers in one table would pool two
            different tokenizers under one arm name.
