...
# Skipped for a sweep whose TSV covers one trainer only: these paper artifacts are
# tracked and carry the main BPE results, and a partial TSV would overwrite them.
# Always collected: the sweep own TSV is its record.
